...
access_token = return_access_token(os.getenv('client_id_spotify'),os.getenv('client_secret_spotify'),os.getenv('refresh_token'))
...
conn = libsql.connect(os.getenv('turso_db'),sync_url=os.getenv('turso_db_url'), auth_token=os.getenv('turso_auth_token'))
...
sleep(2)
load_data_2_db(artists_listened,artists_listened_column,artists_details,primary_key_artist,'UPDATE SET')
